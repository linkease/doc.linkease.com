  ...
  <div id="page" class="mobile">
    ...
    <div class="mobile_top">
      ...
      <div class="btn_box">
        <div class="video-box" @click="openModal(otherUrl.videoUrl1)"><span>观看视频</span><img class="icon"
            :src="logo_video" /></div>
        <div class="video-box" @click="liveDialogVisible = true" style="margin-left: 12px;"><span>直播连线</span></div>
      </div>
    </div>
    <!-- 产品介绍 -->
    ...
    <div class="mobile_product">
      <div class="product">
        ...
        <div class="product_guide" v-if="tabIndex1===1">
          <ul>
            <li v-for="(item,index) in platformList1" v-if="!(!moreStatus1&&index>2)" :key="index"
              @click="openUrl(item.url)"><span>{{ item.name }} </span><img :src="icon_arrow" class="arrow" /></li>
            <div class="readMore" v-if="!moreStatus1" @click="moreStatus1=true">查看全部</div>
          </ul>
        </div>
        <div class="product_question" v-if="tabIndex1===2">
          <ul>
            <li v-for="(item,index) in question1" :key="index" v-if="!(!moreStatus2&&index>2)"
              @click="openUrl(item.url)"><span>{{ item.name }} </span><img :src="icon_arrow" class="arrow" /></li>
      ...
      <div class="product">
        ...
        <div class="product_guide" v-if="tabIndex2===1">
          <ul>
            <li v-for="(item,index) in platformList2" :key="index" v-if="!(!moreStatus3&&index>2)"
              @click="openUrl(item.url)"><span>{{ item.name }} </span><img :src="icon_arrow" class="arrow" /></li>
        ...
        <div class="product_question" v-if="tabIndex2===2">
          <ul>
            <li v-for="(item,index) in question2" :key="index" v-if="!(!moreStatus4&&index>2)"
              @click="openUrl(item.url)"><span>{{ item.name }} </span><img :src="icon_arrow" class="arrow" /></li>
      ...
      <div class="product">
        ...
        <div class="product_guide" v-if="tabIndex3===1">
          <ul>
            <li v-for="(item,index) in platformList3" :key="index" v-if="!(!moreStatus5&&index>2)"
              @click="openUrl(item.url)"><span>{{ item.name }} </span><img :src="icon_arrow" class="arrow" /></li>
        ...
        <div class="product_question" v-if="tabIndex3===2">
          <ul>
            <li v-for="(item,index) in question3" :key="index" v-if="!(!moreStatus6&&index>2)"
              @click="openUrl(item.url)"><span>{{ item.name }} </span><img :src="icon_arrow" class="arrow" /></li>
    ...
    <div class="mobile_operate">
      ...
      <div class="content_right">
        ...
        <ul>
          <li v-for="(item, index) in questionTotal" :key="index" v-if="!(!moreStatus7 && index > 2)"
            @click="openUrl(item.url)"><span>{{ item.name }} </span><img :src="icon_arrow" class="arrow" /></li>
    ...
    <div class="video-moban" v-if="liveDialogVisible">
      <div class="live_box">
        ...
        <p style="text-align: center;">每周三、五 19:30，宝哥与你相约直播间！</p>
