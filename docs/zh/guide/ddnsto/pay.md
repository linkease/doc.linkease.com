...
**<font color=#ff0000 > 每个用户至多拥有2个设备可以领取免费试用套餐，有效期为7天，不可叠加。试用到期后可继续申请试用。 </font>**

**<font color=#ff0000 > 即：拥有超过2个设备，任一设备都不能领取免费试用套餐；需将暂时不用的(或离线)设备删除，保证此账号只拥有2个或1个设备才能领取免费套餐。 </font>**
