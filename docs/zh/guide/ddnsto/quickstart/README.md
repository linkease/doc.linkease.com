...
![获取Token](../resources/koolshare_merlin/image-20210201221633684.png)
...
2. 等待你的设备出现在列表中（约 1 分钟）
3. 点击设备右侧的 **"+"** 添加域名

![添加域名](../resources/koolshare_merlin/image-20210201224437222.png)

4. 填写映射信息：
   - **域名前缀**：自定义，如 `mynas`（最终访问地址为 `https://mynas.ddnsto.com`）
   - **目标主机**：填写内网服务的 IP 和端口，如 `http://192.168.1.100:5000`

![填写映射](../resources/koolshare_merlin/image-20210203210534480.png)

5. 点击"添加"，等待 1 分钟后即可访问！
