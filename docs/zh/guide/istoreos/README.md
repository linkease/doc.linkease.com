...
* ARS2 [固件最初硬件产品，没有这个产品，就没有这个项目](https://easepi.linkease.com)
* X86
* R2S
* R4S
* R5S
...
* 建议使用[易有云 APP](https://doc.linkease.com/zh/guide/linkease_app/#客户端介绍) 做远程应用控制，方便手机远程控制应用
...
* [Github Action编译固件](https://github.com/xiangfeidexiaohuo/OpenWrt_Build)
* [第三方集合插件库](https://github.com/xiangfeidexiaohuo/openwrt-packages)
