# BeeconMini SEED AC5 安装教程


## 1.下载固件

* [SEED AC5 固件下载](https://site.istoreos.com/firmware/download?devicename=seed-ac5&firmware=iStoreOS)

越前面版本越新，请注意看中间的日期，比如 istoreos-x.x.x-**2025110513**-ac5-squashfs-sysupgrade.bin。
